          ...
          filteredDecryptedEntries.map((secret) => {
            ...
            return (
              <div
                ...
                className={`group relative text-left w-full p-4 rounded-xl border transition-all duration-200 flex items-center justify-between gap-3 hover:scale-[1.01] ${
                  isSelected
                    ? "bg-white text-black shadow-xl shadow-white/5 border-white"
                    : "bg-[#0c0c0c]/80 border-white/5 hover:border-emerald-500/30 text-white hover:bg-white/[0.03] hover:shadow-[0_0_15px_rgba(16,185,129,0.03)]"
                }`}
              >
