...
export function InspectorHeader({ secret }: { secret: DecryptedSecret }) {
  const { toggleFavorite, setEditingId, setIsFormOpen } = useVaultContext();
  return (
    <div className="flex items-start justify-between gap-3 border-b border-white/5 pb-3">
      ...
      <div className="flex items-center gap-1 shrink-0">
        ...
        <button
          onClick={() => { setEditingId(secret.id!); setIsFormOpen(true); }}
