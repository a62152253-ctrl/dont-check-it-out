...
export function VaultUnlock({
  ...
  return (
    <div className="relative max-w-md mx-auto bg-[#0a0a0a]/90 backdrop-blur-md border border-white/10 rounded-2xl p-8 space-y-6 shadow-2xl relative my-16 overflow-hidden cyber-scanner">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          <div className="flex items-center justify-between mb-1.5 px-0.5">
            <label className="text-[10px] font-mono uppercase text-emerald-500/80 tracking-wider font-bold">
              {t.masterPassLabel}
            </label>
