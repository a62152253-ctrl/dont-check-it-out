...
interface CategoryDetailsProps {
  ...
  setVisiblePasswords: any;
  copyText: any;
  handleCopyAWSExports?: any;
  handleCopyDbUri?: any;
  handleDownloadDotenv?: any;
}

const AwsCategoryDetails = ({ secret, isPassVisible, copiedId, copiedField, setVisiblePasswords, copyText, handleCopyAWSExports }: CategoryDetailsProps) => (
...
const DatabaseCategoryDetails = ({ secret, isPassVisible, setVisiblePasswords, handleCopyDbUri }: CategoryDetailsProps) => (
...
const SshCategoryDetails = ({ secret, isPassVisible, copiedId, copiedField, setVisiblePasswords, copyText }: CategoryDetailsProps) => (
  <div className="space-y-3">
    <div className="bg-[#121212] border border-white/5 p-2 rounded relative">
...
const ApiKeyCategoryDetails = ({ secret, copiedId, copiedField, copyText, handleDownloadDotenv }: CategoryDetailsProps) => (
  <div className="space-y-3">
...
const StandardCategoryDetails = ({ secret, isPassVisible, copiedId, copiedField, setVisiblePasswords, copyText }: CategoryDetailsProps) => (
  <div className="space-y-3">
    {secret.url && (
        ...
        >
          ...
          <div className="space-y-3.5">
            ...
            {standardizedCategory === "AWS" && secret.developerFields && (
              <AwsCategoryDetails secret={secret} isPassVisible={isPassVisible} copiedId={copiedId} copiedField={copiedField} setVisiblePasswords={setVisiblePasswords} copyText={copyText} handleCopyAWSExports={handleCopyAWSExports} />
            )}

            {/* CATEGORY: Database */}
            {standardizedCategory === "Database" && secret.developerFields && (
              <DatabaseCategoryDetails secret={secret} isPassVisible={isPassVisible} copiedId={copiedId} copiedField={copiedField} setVisiblePasswords={setVisiblePasswords} copyText={copyText} handleCopyDbUri={handleCopyDbUri} />
            )}

            {/* CATEGORY: SSH Keys */}
            {standardizedCategory === "SSH Keys" && secret.developerFields && (
              <SshCategoryDetails secret={secret} isPassVisible={isPassVisible} copiedId={copiedId} copiedField={copiedField} setVisiblePasswords={setVisiblePasswords} copyText={copyText} />
            )}

            {/* CATEGORY: API Keys (Dotenv) */}
            {standardizedCategory === "API Keys" && secret.developerFields && (
              <ApiKeyCategoryDetails secret={secret} isPassVisible={isPassVisible} copiedId={copiedId} copiedField={copiedField} setVisiblePasswords={setVisiblePasswords} copyText={copyText} handleDownloadDotenv={handleDownloadDotenv} />
            )}

            {/* STANDARD CATEGORIES: Websites / Notes / Emails */}
            {["Websites", "Emails", "Notes", "Servers"].includes(standardizedCategory) && (
              <StandardCategoryDetails secret={secret} isPassVisible={isPassVisible} copiedId={copiedId} copiedField={copiedField} setVisiblePasswords={setVisiblePasswords} copyText={copyText} />
            )}
