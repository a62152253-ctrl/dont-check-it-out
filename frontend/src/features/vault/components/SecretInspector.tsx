            ...
            {secret.isLegacy && (
              <div className="bg-amber-950/10 border border-amber-900/30 p-3 rounded-lg text-amber-300 text-[10px] space-y-2">
                ...
                <button
                  ...
                  className="w-full py-1.5 bg-amber-500 hover:bg-amber-400 text-black font-bold font-mono text-[9px] uppercase rounded transition-all"
                >
            ...
            {standardizedCategory === "AWS" && secret.developerFields && (
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full py-2 bg-orange-600/10 hover:bg-orange-600/20 border border-orange-600/20 text-orange-300 font-semibold font-mono text-[10px] rounded transition-all flex items-center justify-center gap-1.5"
                >
