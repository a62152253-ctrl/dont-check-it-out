    ...
    <div className="lg:col-span-4">
      <AnimatePresence mode="wait">
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className="bg-[#0c0c0c]/80 backdrop-blur-md border border-white/10 rounded-2xl p-5 space-y-4 shadow-2xl relative overflow-hidden transition-all duration-300 hover:shadow-[0_0_20px_rgba(16,185,129,0.02)] hover:border-white/20"
        >
