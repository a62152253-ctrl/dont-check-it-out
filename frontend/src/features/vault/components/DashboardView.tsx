              ...
              <div className="space-y-2">
                {recentlyOpenedSecrets.map(secret => (
                  <button
                    ...
                    className="w-full flex items-center justify-between p-3 bg-white/[0.01] border border-white/5 hover:border-emerald-500/20 rounded-lg hover:bg-white/[0.03] transition-all text-left group hover:scale-[1.01]"
                  >
