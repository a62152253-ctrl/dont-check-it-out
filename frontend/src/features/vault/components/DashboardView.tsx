...
export function DashboardView() {
  ...
  const duplicatedCount = useMemo(() => {
    const active = decryptedEntries.filter((e) => !e.isTrash);
    const passwords = active
      .map((e) => e.password || e.developerFields?.awsSecretAccessKey || "")
      .filter(Boolean);
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-[#0c0c0c]/85 p-5 rounded-2xl border border-white/10 shadow-xl flex flex-col justify-between hover:-translate-y-0.5 hover:border-white/15 transition-all duration-300 relative group overflow-hidden">
          ...
          <div>
            ...
            <h3 className="text-3xl font-display font-semibold text-white mt-1.5">
              {stats.total}
            </h3>
          </div>
          <p className="text-[9px] font-mono text-slate-500 mt-4">
            Wszystkie aktywne klucze i hasła
          </p>
        </div>
        ...
        <div className="bg-[#0c0c0c]/85 p-5 rounded-2xl border border-white/10 shadow-xl flex flex-col justify-between hover:-translate-y-0.5 hover:border-blue-500/25 transition-all duration-300 relative group overflow-hidden">
          ...
          <div>
            ...
            <h3 className="text-3xl font-display font-semibold text-blue-400 mt-1.5">
              {stats.categoriesCount}
            </h3>
          </div>
          <p className="text-[9px] font-mono text-slate-500 mt-4">
            Aktywne grupy i typy sekretów
          </p>
        </div>
        ...
        <div className="bg-[#0c0c0c]/85 p-5 rounded-2xl border border-white/10 shadow-xl flex flex-col justify-between hover:-translate-y-0.5 hover:border-amber-500/25 transition-all duration-300 relative group overflow-hidden">
          ...
          <div>
            ...
            <h3 className="text-3xl font-display font-semibold text-amber-400 mt-1.5">
              {stats.recentlyAdded}
            </h3>
          </div>
          <p className="text-[9px] font-mono text-slate-500 mt-4">
            Wpisy dodane w ciągu 30 dni
          </p>
        </div>
        ...
        <div className="bg-[#0c0c0c]/85 p-5 rounded-2xl border border-white/10 shadow-xl flex flex-col justify-between hover:-translate-y-0.5 hover:border-rose-500/25 transition-all duration-300 relative group overflow-hidden">
          ...
          <div>
            ...
            <h3 className="text-3xl font-display font-semibold text-rose-400 mt-1.5">
              {stats.favorites}
            </h3>
          </div>
          <p className="text-[9px] font-mono text-slate-500 mt-4">
            Oznaczone jako ulubione dewelopera
          </p>
        </div>
      </div>
        ...
        <div className="md:col-span-7 space-y-6">
          ...
          <div className="bg-[#0c0c0c] border border-white/5 rounded-lg p-5 space-y-4">
            <div className="flex items-center gap-2 border-b border-white/5 pb-2.5">
              ...
              <h4 className="text-[11px] font-bold uppercase tracking-wider text-slate-300">
                Recently Opened / Ostatnio używane
              </h4>
            </div>
          ...
          <div className="bg-[#0c0c0c] border border-white/5 rounded-lg p-5 space-y-4">
            <div className="flex items-center gap-2 border-b border-white/5 pb-2.5">
              ...
              <h4 className="text-[11px] font-bold uppercase tracking-wider text-slate-300">
                Security Overview / Audyt bezpieczeństwa
              </h4>
            </div>
              ...
              <div className="space-y-2 pt-1">
                <div className="flex items-center justify-between text-xs font-mono py-1.5 border-b border-white/5">
                  <span className="flex items-center gap-2 text-slate-400">
                    ...
                    Szyfrowany sejf lokalny (Encrypted Vault)
                  </span>
                ...
                <div className="flex items-center justify-between text-xs font-mono py-1.5 border-b border-white/5">
                  <span className="flex items-center gap-2 text-slate-400">
                    {stats.weak === 0 ? (
                      <>
                        <span className="text-emerald-500 font-bold">✓</span>{" "}
                        Brak słabych haseł deweloperskich
                      </>
                    ) : (
                      <>
                        <span className="text-rose-500 font-bold">⚠</span>{" "}
                        {stats.weak} słabe hasła deweloperskie
                      </>
                    )}
                  </span>
                  <span
                ...
                <div className="flex items-center justify-between text-xs font-mono py-1.5 border-b border-white/5">
                  <span className="flex items-center gap-2 text-slate-400">
                    {duplicatedCount === 0 ? (
                      <>
                        <span className="text-emerald-500 font-bold">✓</span>{" "}
                        Wszystkie hasła są unikalne
                      </>
                    ) : (
                      <>
                        <span className="text-amber-500 font-bold">⚠</span>{" "}
                        Wykryto {duplicatedCount} powtórzone hasła
                      </>
                    )}
                  </span>
                  <span
                ...
                <div className="flex items-center justify-between text-xs font-mono py-1.5">
                  <span className="flex items-center gap-2 text-slate-400">
                    {oldSecretsCount === 0 ? (
                      <>
                        <span className="text-emerald-500 font-bold">✓</span>{" "}
                        Wszystkie hasła są świeże
                      </>
                    ) : (
                      <>
                        <span className="text-slate-500 font-bold">⚠</span>{" "}
                        {oldSecretsCount} sekretów ma ponad 90 dni
                      </>
                    )}
                  </span>
                  <span
        ...
        <div className="md:col-span-5 space-y-6">
          ...
          <div className="bg-[#0c0c0c] border border-white/5 rounded-lg p-5 space-y-4">
            <div className="flex items-center gap-2 border-b border-white/5 pb-2.5">
              ...
              <h4 className="text-[11px] font-bold uppercase tracking-wider text-slate-300">
                Vault Activity / Dziennik zdarzeń
              </h4>
            </div>
            ...
            {activityLogs.length === 0 ? (
              ...
              <div className="space-y-3 max-h-[300px] overflow-y-auto pr-1">
                {activityLogs.slice(0, 7).map((log, index) => (
                  <div
                    key={index}
                    className="flex items-start justify-between text-xs border-b border-white/5 pb-2.5 last:border-0 last:pb-0 font-mono"
                  >
                    <div className="space-y-0.5">
                      <p className="text-white font-medium text-[11px]">
                        {log.action}
                      </p>
                      <p className="text-[9px] text-slate-500 break-all leading-normal">
                        {log.detail}
                      </p>
                    </div>
